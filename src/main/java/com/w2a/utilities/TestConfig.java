...
public class TestConfig{
	...
	public static String from = "kundaramit@gmail.com";
	public static String password = "Qwerty@24031996";
	public static String[] to ={"kundaramit55@gmail.com","trainer@way2automation.com"};
